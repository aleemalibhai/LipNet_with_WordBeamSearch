...
if(__name__ == '__main__'):
    with open('/home/aalibhai/Thesis/LipNet-CTCWBS/data/LRS3_val.txt', 'r') as f:
        data = [os.path.join('/scratch/aalibhai/LRS3/', line.strip()) for line in f.readlines()]


    
    annos = [name.replace('LRS3', 'LRS3_annos') for name in data]  
    targets = [name.replace('LRS3', 'LRS3_lip') for name in data]  
    
    for ann, dst in zip(annos, targets):
